...
public class CharacterController2D : MonoBehaviour
{
	...
	public class RayWithVelocityInfo {
		public RayWithVelocityInfo(RaycastHit2D raycastHit2D, Vector3 velocity) {
	...
	public event Action<RayWithVelocityInfo> onControllerCollidedEvent;
	...
	public void move( Vector3 deltaMovement )
	{
		...
		if( onControllerCollidedEvent != null )
		{
			for( var i = 0; i < _raycastHitsThisFrame.Count; i++ )
				onControllerCollidedEvent( new RayWithVelocityInfo(_raycastHitsThisFrame[i], lastVelocity) );
